...
const activities = [
  { id: 1, action: 'Sale completed', details: 'Order #1247 - TZS 2,450,000', time: '5 min ago', type: 'sale' },
  { id: 2, action: 'Stock updated', details: 'Portland Cement +100 bags', time: '15 min ago', type: 'stock' },
  { id: 3, action: 'New customer', details: 'Dodoma Builders registered', time: '1 hour ago', type: 'customer' },
  { id: 4, action: 'Sale completed', details: 'Order #1246 - TZS 680,000', time: '2 hours ago', type: 'sale' },
  { id: 5, action: 'Low stock alert', details: 'Angle Grinder 7" - 2 units', time: '3 hours ago', type: 'alert' },
];
